...
#PRE - BP_Correction(bp_correct_t_f = FALSE, f_out = "beat_NVT29_pre_control.csv", col_names = c("Time", "SPO2", "SBP", "DBP", "MAP", "HR", "SV", "CO", "TPR", "V_ba"))

#POST - BP_Correction(bp_correct_t_f = FALSE, f_out = "beat_NVT28_post_control.csv", col_names = c("Time", "SPO2", "SBP", "DBP", "MAP", "HR", "SV", "CO", "TPR", "V_ba"))
