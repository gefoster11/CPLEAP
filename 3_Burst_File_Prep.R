...
#eg. burst_file(col_names = c("Time", "Sel_Duration", "BP_Comment", "MSNA_Comment", "MSNA_Num", "MSNA_Baseline", "MSNA_Amplitude"), base_start = 31.2499, base_end = 31.2499+300, f_out = "burst_NVT06_pre_IH.csv")

#PRE- burst_file(col_names = c("Time", "Sel_Duration", "BP_Comment", "MSNA_Comment", "MSNA_Num", "MSNA_Baseline", "MSNA_Amplitude"), base_start = 4459.21036, base_end = 4459.21036+60, f_out = "burst_NVT36_pre_control.csv")

#POST- burst_file(col_names = c("Time", "Sel_Duration", "BP_Comment", "MSNA_Comment", "MSNA_Num", "MSNA_Baseline", "MSNA_Amplitude"), base_start = 8489.420113, base_end = 8489.420113+60, f_out = "burst_NVT36_post_control.csv")
...
burst_file <- function(col_names, base_start, base_end, f_out) {
  ...
  data <- filter(data, MSNA_Comment == "BURST" | MSNA_Comment == "burst")
